...
// make sure your redis url starts with rediss://default
...
SMTP_PASSWORD = //SMTP password is typically found in the settings or security section of your email service provider. You may need to generate an App Password for services like Gmail to use in SMTP configurations.
